...
import com.nameserver.common.*;
import com.nameserver.protocol.BrokerData;
import com.nameserver.protocol.QueueData;
import com.nameserver.protocol.TopicRouteData;
import com.nameserver.protocol.body.ClusterInfo;
import com.nameserver.protocol.body.RegisterBrokerResult;
import com.nameserver.protocol.body.TopicConfigSerializeWrapper;
...
public class RouteInfoManager {
    ...
    public int wipeWritePermOfBrokerByLock(final String brokerName) {
        try {
            ...
            logger.error("wipeWritePermOfBrokerByLock Exception", e);
        }
    ...
    public RegisterBrokerResult registerBroker(//
                                               ...
                                               final io.netty.channel.Channel channel// 8
    ) {
        ...
        try {
            try {
                ...
                if (null != topicConfigWrapper //
                        && NamesrvUtil.MASTER_ID == brokerId) {
                ...
                // 返回值
                if (NamesrvUtil.MASTER_ID != brokerId) {
                    String masterAddr = brokerData.getBrokerAddrs().get(NamesrvUtil.MASTER_ID);
                    if (masterAddr != null) {
    ...
    public void scanNotActiveBroker() {
        ...
        while (it.hasNext()) {
            ...
            if ((last + BrokerChannelExpiredTime) < System.currentTimeMillis()) {
                ...
                it.remove();
                logger.warn("The broker channel expired, {} {}ms", next.getKey(), BrokerChannelExpiredTime);
            ...
            while (it.hasNext()) {
                ...
                if (qd.getBrokerName().equals(brokerName)) {
                    if (qd.equals(queueData)) {
                        ...
                        logger.info("topic changed, {} OLD: {} NEW: {}", topicConfig.getTopicName(), qd,
                                queueData);
                        it.remove();
                    }
                }
